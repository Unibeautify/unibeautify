        ...
        test("should successfully parse version and return first valid version from array of patterns", () => {
            ...
            return Promise.all([dependency1.load(), dependency2.load()]).then(
                () => {
                    ...
                    expect(
                        dependency1.version && dependency1.version.major
                    ).not.toBe(0);
                    expect(
                        dependency1.version && dependency1.version.major
                    ).toBe(1);
                    expect(
                        dependency2.version && dependency2.version.major
                    ).not.toBe(0);
                    expect(
                        dependency2.version && dependency2.version.major
                    ).toBe(1);
                    ...
                    expect(
                        dependency1.version && dependency1.version.minor
                    ).not.toBe(0);
                    expect(
                        dependency1.version && dependency1.version.minor
                    ).toBe(2);
                    expect(
                        dependency2.version && dependency2.version.minor
                    ).toBe(0);

                    expect(
                        dependency1.version && dependency1.version.patch
                    ).not.toBe(0);
                    expect(
                        dependency1.version && dependency1.version.patch
                    ).toBe(3);
                    expect(
                        dependency2.version && dependency2.version.patch
                    ).toBe(0);
                }
            );
        });
