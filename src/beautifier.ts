...
export interface Beautifier {
  ...
  */
     ...
     */
    resolveConfig?(
        resolveConfigData: ResolveConfigData
...
export class Unibeautify {
  ...
  */
    ...
    private beautifiersForLanguageAndOptions(
        ...
        const allBeautifiers: Beautifier[] = this.getBeautifiersForLanguage(
            lang
        );
                        ...
                        .then(() => {
                            if (
                                ...
                                const resolveConfigPath: string | undefined =
                                    typeof beautifierOptions.prefer_beautifier_config ===
                                    'string'
                                        ? beautifierOptions.prefer_beautifier_config
                                        : filePath;
  ...
  */
    public static getOptionsForBeautifier(
        ...
        if (
            typeof beautifierOptions === 'boolean' &&
            beautifierOptions === false
        ) {
            return {};
            ...
            return Object.keys(beautifierOptions).reduce(
                (acc: OptionValues, key: string) => {
                    ...
                    console.log(
                        `Invalid option "${key}" with value ${JSON.stringify(
                            option
                        )}.`
                    );
                    return acc;
